...
export class Landing extends React.Component {
    ...
    render() {
        return <div> <h1>My Lil' Genshin Impact Fanpage (Unoffical version)! </h1> 
        <h5>In the following pages, you will see the learn about different the Genshin Impact characters, 
            that I have pulled/wished for. And there will be a forum for you to partcipate in.</h5>
             <h6>Spolier: You may post things to the forum, but it may not be saved</h6>
             <p><img src="https://media.discordapp.net/attachments/727960210534301727/849435214363099166/2021414183557.png?width=629&height=354"></img></p> 
